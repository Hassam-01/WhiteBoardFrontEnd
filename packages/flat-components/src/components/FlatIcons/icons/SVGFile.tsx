...
export const SVGFile: React.FC<FlatIconProps> = ({ active, className = "", ...restProps }) => {
    return (
        <svg
        ...
        >
            ...
            <path
                className="flat-icon-fill-color"
                clipRule="evenodd"
                d="M13.375 9V3a.625.625 0 0 1 1.067-.442l6 6A.625.625 0 0 1 20 9.625h-6A.625.625 0 0 1 13.375 9Zm5.117-.625-3.867-3.867v3.867h3.867Z"
                fill="#6F3393"
                fillRule="evenodd"
            ></path>
        </svg>
